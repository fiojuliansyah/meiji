"use strict";
var KTLevelsList = (function () {
    var t,
        e,
        n,
        r,
        o = document.getElementById("kt_levels_table"),
        c = () => {
            o.querySelectorAll(
                '[data-kt-level-table-filter="delete_row"]'
            ).forEach((t) => {
        ...
        l = () => {
            ...
            (t = document.querySelector(
                '[data-kt-level-table-toolbar="base"]'
            )),
                (n = document.querySelector(
                    '[data-kt-level-table-toolbar="selected"]'
                )),
                (r = document.querySelector(
                    '[data-kt-level-table-select="selected_count"]'
                ));

            const s = document.querySelector(
                '[data-kt-level-table-select="delete_selected"]'
            );
                    ...
                    if (t.value) {
                        ...
                        c.forEach((checkbox) => {
                            if (
                                ...
                                selectedlevelIds.push(checkbox.value);
                            }
                        });
    ...
    return {
        init: function () {
            if (o) {
                ...
                document
                    .querySelector('[data-kt-level-table-filter="search"]')
