...
var KTLocationsList = (function () {
    var t,
        ...
        n,
        r,
        o = document.getElementById("kt_locations_table"),
        c = () => {
            o.querySelectorAll(
                '[data-kt-location-table-filter="delete_row"]'
            ).forEach((t) => {
        ...
        l = () => {
            ...
            (t = document.querySelector(
                '[data-kt-location-table-toolbar="base"]'
            )),
                (n = document.querySelector(
                    '[data-kt-location-table-toolbar="selected"]'
                )),
                (r = document.querySelector(
                    '[data-kt-location-table-select="selected_count"]'
                ));

            const s = document.querySelector(
                '[data-kt-location-table-select="delete_selected"]'
            );
    ...
    return {
        init: function () {
            if (o) {
                ...
                document
                    .querySelector('[data-kt-location-table-filter="search"]')
