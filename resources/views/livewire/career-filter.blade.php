                  ...
                  <div class="col-lg-9 col-md-12 col-sm-12 col-12 float-right">
                      <div class="content-page">
                          <div class="box-filters-job">
                              <div class="row">
                                  <div class="col-xl-6 col-lg-5"><span class="text-small text-showing">Showing <strong>{{ $careers->firstItem() }}-{{ $careers->lastItem() }} of {{ $careers->total() }} jobs </strong>of <strong>944 </strong>jobs</span></div>
                          ...
                          <div class="sidebar-filters">
                              ...
                              <div class="filter-block mb-30">
                                  <div class="form-group select-style select-style-icon">
                                      <div wire:ignore>
                                          <select class="form-control form-icons" wire:model="filterLocation" id="select2">
                              ...
                              <div class="filter-block mb-20">
                                  ...
                                  <div class="form-group">
                                      <ul class="list-checkbox">
                                          ...
                                          <li>
                                              <label class="cb-container">
                                                  <input type="checkbox" wire:model.live="filterDepartement" value="{{ $departement->id }}" class="departement-checkbox" checked="checked"><span class="text-small">{{ $departement->name }}</span><span class="checkmark"></span>
                              ...
                              <div class="filter-block mb-30">
                                  ...
                                  <div class="form-group">
                                      <ul class="list-checkbox">
                                          ...
                                          <li>
                                              <label class="cb-container">
                                                  <input type="checkbox" wire:model.live="filterPlacement" value="{{ $placement->placement }}"><span
