...
<main class="main">
                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-12">
                        <div class="block-banner">
                            <h1 class="heading-banner wow animate__animated animate__fadeInUp">Find Jobs,<br class="d-none d-lg-block">Hire Creatives</h1>
                            <div class="banner-description mt-20 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">Each month, more than 3 million job seekers turn to website in their search for work, making over 140,000 applications every single day</div>
                            <div class="mt-30"> <a class="btn btn-default mr-15">Get Started</a><a class="btn btn-border-brand-2">Learn more</a></div>
                            <div class="mt-50 mb-20"><span class="font-md color-text-paragraph-2">Trusted by</span></div>
                            <div class="box-logos-485">
                                <div class="box-swiper">
                                    <div class="swiper-container swiper-group-4-banner swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide"><a href="#"><img src="fe_assets/imgs/page/homepage3/microsoft.svg" alt="jobBox"></a></div>
                                            <div class="swiper-slide"><a href="#"><img src="fe_assets/imgs/page/homepage3/sony.svg" alt="jobBox"></a></div>
                                            <div class="swiper-slide"><a href="#"><img src="fe_assets/imgs/page/homepage3/acer.svg" alt="jobBox"></a></div>
                                            <div class="swiper-slide"><a href="#"><img src="fe_assets/imgs/page/homepage3/nokia.svg" alt="jobBox"></a></div>
                                            <div class="swiper-slide"><a href="#"><img src="fe_assets/imgs/page/homepage3/asus.svg" alt="jobBox"></a></div>
                                            <div class="swiper-slide"><a href="#"><img src="fe_assets/imgs/page/homepage3/casio.svg" alt="jobBox"></a></div>
                                            <div class="swiper-slide"><a href="#"><img src="fe_assets/imgs/page/homepage3/dell.svg" alt="jobBox"></a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-5 col-lg-12 d-none d-xl-block col-md-6">
                        <div class="banner-imgs">
                            <div class="banner-1 shape-1"><img class="img-responsive" alt="jobBox" src="fe_assets/imgs/page/homepage5/banner1.png"></div>
                            <div class="banner-2 shape-2"><img class="img-responsive" alt="jobBox" src="fe_assets/imgs/page/homepage5/banner2.png"></div>
                            <div class="banner-3 shape-3"><img class="img-responsive" alt="jobBox" src="fe_assets/imgs/page/homepage5/banner3.png"></div>
                            <div class="banner-4 shape-3"><img class="img-responsive" alt="jobBox" src="fe_assets/imgs/page/homepage5/banner4.png"></div>
                            <div class="banner-5 shape-2"><img class="img-responsive" alt="jobBox" src="fe_assets/imgs/page/homepage5/banner5.png"></div>
                            <div class="banner-6 shape-1"><img class="img-responsive" alt="jobBox" src="fe_assets/imgs/page/homepage5/banner6.png"></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-container swiper-group-3-explore mh-none swiper">
                            <div class="swiper-wrapper pb-70 pt-5">
                                <div class="swiper-slide hover-up">
                                    <div class="card-grid-5 card-category hover-up" style="background-image: url('fe_assets/imgs/page/homepage4/img-big1.png')"><a href="jobs-grid.html">
                                ...
                                <div class="swiper-slide hover-up">
                                    <div class="card-grid-5 card-category hover-up" style="background-image: url('fe_assets/imgs/page/homepage4/img-big2.png')"><a href="jobs-grid.html">
                                            <div class="box-cover-img">
                                                <div class="content-bottom">
                                ...
                                <div class="swiper-slide hover-up">
                                    <div class="card-grid-5 card-category hover-up" style="background-image: url('fe_assets/imgs/page/homepage4/img-big3.png')"><a href="jobs-grid.html">
                                            <div class="box-cover-img">
                                                <div class="content-bottom">
                                ...
                                <div class="swiper-slide hover-up">
                                    <div class="card-grid-5 card-category hover-up" style="background-image: url('fe_assets/imgs/page/homepage4/img-big4.png')"><a href="jobs-grid.html">
                                            <div class="box-cover-img">
                                                <div class="content-bottom">
                                ...
                                <div class="swiper-slide hover-up">
                                    <div class="card-grid-5 card-category hover-up" style="background-image: url('fe_assets/imgs/page/homepage4/img-big5.png')"><a href="jobs-grid.html">
                                            <div class="box-cover-img">
                                                <div class="content-bottom">
                                ...
                                <div class="swiper-slide hover-up">
                                    <div class="card-grid-5 card-category hover-up" style="background-image: url('fe_assets/imgs/page/homepage4/img-big6.png')"><a href="jobs-grid.html">
                                            <div class="box-cover-img">
                                                <div class="content-bottom">
                ...
                <div class="text-start">
                    ...
                    <div class="list-tabs list-tabs-2 mt-30">
                        <ul class="nav nav-tabs" role="tablist">
                            <li><a class="active" id="nav-tab-job-1" href="#tab-job-1" data-bs-toggle="tab" role="tab" aria-controls="tab-job-1" aria-selected="true"><img src="fe_assets/imgs/page/homepage1/management.svg" alt="jobBox"> Management</a></li>
                            <li><a id="nav-tab-job-2" href="#tab-job-2" data-bs-toggle="tab" role="tab" aria-controls="tab-job-2" aria-selected="false"><img src="fe_assets/imgs/page/homepage1/marketing.svg" alt="jobBox"> Marketing &amp; Sale</a></li>
                            <li><a id="nav-tab-job-3" href="#tab-job-3" data-bs-toggle="tab" role="tab" aria-controls="tab-job-3" aria-selected="false"><img src="fe_assets/imgs/page/homepage1/finance.svg" alt="jobBox"> Finance</a></li>
                            <li><a id="nav-tab-job-4" href="#tab-job-4" data-bs-toggle="tab" role="tab" aria-controls="tab-job-4" aria-selected="false"><img src="fe_assets/imgs/page/homepage1/human.svg" alt="jobBox"> Human Resource</a></li>
                            <li><a id="nav-tab-job-5" href="#tab-job-5" data-bs-toggle="tab" role="tab" aria-controls="tab-job-5" aria-selected="false"><img src="fe_assets/imgs/page/homepage1/retail.svg" alt="jobBox"> Retail &amp; Products</a></li>
                            <li><a id="nav-tab-job-6" href="#tab-job-6" data-bs-toggle="tab" role="tab" aria-controls="tab-job-6" aria-selected="false"><img src="fe_assets/imgs/page/homepage1/content.svg" alt="jobBox"> Content Writer</a></li>
                            <li><a id="nav-tab-job-7" href="#tab-job-7" data-bs-toggle="tab" role="tab" aria-controls="tab-job-7" aria-selected="false"><img src="fe_assets/imgs/page/homepage1/content.svg" alt="jobBox"> Funiture Design</a></li>
                            <li><a id="nav-tab-job-8" href="#tab-job-8" data-bs-toggle="tab" role="tab" aria-controls="tab-job-8" aria-selected="false"><img src="fe_assets/imgs/page/homepage1/content.svg" alt="jobBox"> Other</a></li>
                        </ul>
                    </div>
                </div>
                <div class="mt-50">
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        <div class="card-grid-2-image"><span class="lbl-hot bg-green"><span>Freelancer</span></span>
                                            <div class="image-box">
                                                <figure><img src="fe_assets/imgs/page/homepage2/img1.png" alt="jobBox"></figure>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        <div class="card-grid-2-image"><span class="lbl-hot"><span>Full time</span></span>
                                            <div class="image-box">
                                                <figure><img src="fe_assets/imgs/page/homepage2/img2.png" alt="jobBox"></figure>
                                            </div>
                                        </div>
                                        <div class="card-block-info">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        <div class="card-grid-2-image"><span class="lbl-hot"><span>Full time</span></span>
                                            <div class="image-box">
                                                <figure><img src="fe_assets/imgs/page/homepage2/img3.png" alt="jobBox"></figure>
                                            </div>
                                        </div>
                                        <div class="card-block-info">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        <div class="card-grid-2-image"><span class="lbl-hot"><span>Full time</span></span>
                                            <div class="image-box">
                                                <figure><img src="fe_assets/imgs/page/homepage2/img4.png" alt="jobBox"></figure>
                                            </div>
                                        </div>
                                        <div class="card-block-info">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        <div class="card-grid-2-image"><span class="lbl-hot"><span>Full time</span></span>
                                            <div class="image-box">
                                                <figure><img src="fe_assets/imgs/page/homepage2/img5.png" alt="jobBox"></figure>
                                            </div>
                                        </div>
                                        <div class="card-block-info">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        <div class="card-grid-2-image"><span class="lbl-hot"><span>Full time</span></span>
                                            <div class="image-box">
                                                <figure><img src="fe_assets/imgs/page/homepage2/img6.png" alt="jobBox"></figure>
                                            </div>
                                        </div>
                                        <div class="card-block-info">
    ...
    <section class="section-box mt-50 mb-30 bg-border-3 pt-100 pb-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-6"><img class="bdrd-10" src="fe_assets/imgs/page/homepage5/img-profile.png" alt="jobBox"></div>
                <div class="col-lg-6">
                    <div class="pl-30">
    ...
    <section class="section-box mt-70">
        <div class="container">
            <div class="text-start">
                ...
                <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Jobs is a curated job board of the best jobs for developers, designers<br class="d-none d-lg-block">and marketers in the tech industry.</p>
            </div>
                ...
                <div class="row">
                        ...
                        <div class="card-grid-2 hover-up">
                            <div class="card-grid-2-image-left">
                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                        <figure><img alt="jobBox" src="fe_assets/imgs/page/candidates/user1.png"></figure>
                                    </a></div>
                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                        <h5>Robert Fox</h5>
                                    </a><span class="font-xs color-text-mutted">UI/UX Designer</span>
                                    <div class="rate-reviews-small pt-5"><span><img src="fe_assets/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="fe_assets/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="fe_assets/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="fe_assets/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="fe_assets/imgs/template/icons/star.svg" alt="jobBox"></span><span class="ml-10 color-text-mutted font-xs">(65)</span></div>
                                </div>
                            </div>
                            <div class="card-block-info">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card-grid-2 hover-up">
                            <div class="card-grid-2-image-left">
                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                        <figure><img alt="jobBox" src="fe_assets/imgs/page/candidates/user2.png"></figure>
                                    </a></div>
                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                        <h5>Cody Fisher</h5>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card-grid-2 hover-up">
                            <div class="card-grid-2-image-left">
                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                        <figure><img alt="jobBox" src="fe_assets/imgs/page/candidates/user3.png"></figure>
                                    </a></div>
                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                        <h5>Jerome Bell</h5>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card-grid-2 hover-up">
                            <div class="card-grid-2-image-left">
                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                        <figure><img alt="jobBox" src="fe_assets/imgs/page/candidates/user4.png"></figure>
                                    </a></div>
                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                        <h5>Jane Cooper</h5>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card-grid-2 hover-up">
                            <div class="card-grid-2-image-left">
                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                        <figure><img alt="jobBox" src="fe_assets/imgs/page/candidates/user5.png"></figure>
                                    </a></div>
                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                        <h5>Floyd Miles</h5>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card-grid-2 hover-up">
                            <div class="card-grid-2-image-left">
                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                        <figure><img alt="jobBox" src="fe_assets/imgs/page/candidates/user6.png"></figure>
                                    </a></div>
                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                        <h5>Devon Lane</h5>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card-grid-2 hover-up">
                            <div class="card-grid-2-image-left">
                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                        <figure><img alt="jobBox" src="fe_assets/imgs/page/candidates/user7.png"></figure>
                                    </a></div>
                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                        <h5>Jerome Bell</h5>
                                    </a><span class="font-xs color-text-mutted">UI/UX Designer</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card-grid-2 hover-up">
                            <div class="card-grid-2-image-left">
                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                        <figure><img alt="jobBox" src="fe_assets/imgs/page/candidates/user8.png"></figure>
                                    </a></div>
                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                        <h5>Eleanor</h5>
                                    </a><span class="font-xs color-text-mutted">UI/UX Designer</span>
                    ...
                    <div class="swiper-container swiper-group-3 swiper">
                        <div class="swiper-wrapper pb-70 pt-5">
                            <div class="swiper-slide">
                                <div class="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                                    <div class="text-center card-grid-3-image"><a href="#">
                                            <figure><img alt="jobBox" src="fe_assets/imgs/page/homepage1/img-news1.png"></figure>
                                        </a></div>
                                    <div class="card-block-info">
                                        ...
                                        <div class="card-2-bottom mt-20">
                                            <div class="row">
                                                <div class="col-lg-6 col-6">
                                                    <div class="d-flex"><img class="img-rounded" src="fe_assets/imgs/page/homepage1/user1.png" alt="jobBox">
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                                    <div class="text-center card-grid-3-image"><a href="#">
                                            <figure><img alt="jobBox" src="fe_assets/imgs/page/homepage1/img-news2.png"></figure>
                                        </a></div>
                                    <div class="card-block-info">
                                        ...
                                        <div class="card-2-bottom mt-20">
                                            <div class="row">
                                                <div class="col-lg-6 col-6">
                                                    <div class="d-flex"><img class="img-rounded" src="fe_assets/imgs/page/homepage1/user2.png" alt="jobBox">
                            ...
                            <div class="swiper-slide">
                                <div class="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                                    <div class="text-center card-grid-3-image"><a href="#">
                                            <figure><img alt="jobBox" src="fe_assets/imgs/page/homepage1/img-news3.png"></figure>
                                        </a></div>
                                    <div class="card-block-info">
                                        <div class="tags mb-15"><a class="btn btn-tag" href="blog-grid.html">News</a></div>
                                        ...
                                        <div class="card-2-bottom mt-20">
                                            <div class="row">
                                                <div class="col-lg-6 col-6">
                                                    <div class="d-flex"><img class="img-rounded" src="fe_assets/imgs/page/homepage1/user3.png" alt="jobBox">
...
<footer class="footer mt-50">
    <div class="container">
        <div class="row">
            <div class="footer-col-1 col-md-3 col-sm-12"><a href="index.html"><img alt="jobBox" src="fe_assets/imgs/template/jobhub-logo.svg"></a>
            ...
            <div class="footer-col-6 col-md-3 col-sm-12">
                ...
                <div class="mt-15"><a class="mr-5" href="#"><img src="fe_assets/imgs/template/icons/app-store.png" alt="joxBox"></a><a href="#"><img src="fe_assets/imgs/template/icons/android.png" alt="joxBox"></a></div>
            </div>
        </div>
