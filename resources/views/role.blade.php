            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <button type="button" class="btn btn-sm fw-bold btn-primary"  data-bs-toggle="modal" data-bs-target="#kt_modal_add_role">Create</button>
                        <!--end::Primary button-->
                    </div>
                    <!--end::Actions-->
                </div>
                            ...
                            <div class="card card-flush h-md-100">
                                ...
                                <div class="card-body pt-1">
                                    ...
                                    <div class="d-flex flex-column text-gray-600">
                                        ...
                                        <div class="d-flex align-items-center py-2">
                                            ...
                                            <span class="badge badge-light-danger mx-2">{{$permission->mock}}</span>
                                            @endforeach
                                        </div>
                                        @endforeach
                                    </div>
                                ...
                                <div class="card-footer flex-wrap pt-0">
                                    ...
                                    <button type="button" class="btn btn-light btn-active-light-primary my-1"
                                        data-bs-toggle="modal" data-bs-target="#kt_modal_update_role-{{$role->id}}">Edit Role</button>
                                </div>
                                <!--end::Card footer-->
                            </div>
                            <!--end::Card-->
